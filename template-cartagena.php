                    ...
                    <div class="position-relative customSectionBox rounded-4 text-center py-5 shadow-1">
                        <div class="col-12 col-xl-9 mx-auto text-start px-xl-0 px-3">
                            ...
                            <div class="bg-yellow-100 mb-xl-5">
                                ...
                                <p class="fs-xl-6 fs-p-xxl text-secondary-200 mb-4 text-secondary" style="line-height: 1.4">While it is not mandatory, it is highly recommended, as it streamlines the immigration process and helps prevent delays at the airport. <a href="https://apps.migracioncolombia.gov.co/pre-registro" style="text-decoration: underline; color: #B8724C;" target="blank">Please click here for the form.</a></p>
