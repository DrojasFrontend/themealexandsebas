...
function sendAdminEmail($guest_name, $guests, $allergies, $email, $phone, $code, $city, $arrival_date, $language = 'en_US') {
    ...
    $event_names = [
        'welcome' => 'WELCOME PARTY (Thursday, march 26, 2026, 5:00 - 8:00 p.m., Mirador Gastro Bar)',
        ...
        'brunch' => 'BEACH DAY (Saturday, march 28, 2026, 11:30 a.m., Eteka Beach)',
    ];
    ...
    <head>
        ...
        <style>
            ...
            .header { background: #B8724C; color: white; padding: 20px; text-align: center; }
            .content { padding: 20px; background: #f9f9f9; }
            .event-section { margin: 15px 0; padding: 15px; background: white; border-left: 4px solid #B8724C; }
            .guest-item { margin: 5px 0; padding: 8px; background: #f5f5f5; }
            .accept { color: #858B70; font-weight: bold; }
    ...
    $message .= '
            <div class="event-section">
                ...
                <p><strong>Arrival Date in Cartagena:</strong> ' . ($arrival_date ?: 'Not provided') . '</p>
            </div>
        </div>
        
        <div class="footer">
            <p>This email was automatically generated by the RSVP system</p>
            <p>Alexandra &  Sebastian\'s Wedding - March 27th, 2026 - Cartagena, Colombia</p>
        </div>
    </body>
    </html>';
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <h2 style="text-align: center; color: #B8724C; margin-bottom: 25px;">📅 Event Details</h2>
                ...
                <div class="events-container">
                    ...
                    <div class="event">
                        ...
                        <div class="event-details">
                            ...
                            <strong>Location:</strong> Eteka Beach
                        </div>
                    </div>
                </div>
...
function generateEnglishDeclineEmail($guest_name, $email, $code, $phone, $city, $arrival_date) {
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                <h3>💕 Thank You</h3>
                <p>Even though you can\'t be with us, you\'re in our hearts</p>
                <p>Alexandra & Sebastian\'s Wedding - March 27th, 2026 - Cartagena, Colombia</p>
            </div>
        </div>
    </body>
