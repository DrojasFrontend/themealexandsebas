...
const invitedGuests = {
    ...
    'José Antonio Zozaya': ['José Antonio Zozaya', 'Vanessa Trutschel', 'José Andrés Zozaya', 'Julieta Zozaya'],
    ...
    'Ana Teresa Fábregas': ['Ana Teresa Fábregas', 'Guest'],
    'Diego Fernández': ['Diego Fernández', 'Alexandra Padrón de Fernández'],
    ...
    'Leonardo Simón': ['Leonardo Simón', 'Clementina Simón', 'Nicolás Simón', 'Leonardo Simón Jr.'],
...
export function initRSVPForm() {
    ...
    // Solo búsqueda con Enter en el campo (sin búsqueda automática al escribir)
    if (searchInput) {
